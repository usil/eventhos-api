...
CREATE TABLE `action_security` (
  ...
  `http_configuration` mediumtext COMMENT 'An http configuration that should resamblace axios config for oauth2 spec.',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
--
-- Dumping events for database 'eventhos'
--

--
-- Dumping routines for database 'eventhos'
--
...
-- Dump completed on 2022-03-22 15:14:18
