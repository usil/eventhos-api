...
-- Schema eventhos
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `eventhos` ;
USE `eventhos` ;

-- -----------------------------------------------------
-- Table `eventhos`.`system`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`system` (
...
-- -----------------------------------------------------
-- Table `eventhos`.`event`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`event` (
...
-- -----------------------------------------------------
-- Table `eventhos`.`action`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`action` (
...
-- -----------------------------------------------------
-- Table `eventhos`.`action_security`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`action_security` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `eventhos`.`contract`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`contract` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `action_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `eventhos`.`variable`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`variable` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `eventhos`.`received_event`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`received_event` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'The id for the event',
...
-- -----------------------------------------------------
-- Table `eventhos`.`contract_exc_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`contract_exc_detail` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'The id for the event',
  ...
  CONSTRAINT `fk_contract_exc_detail_recived_event1`
    ...
    REFERENCES `eventhos`.`received_event` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_contract_exc_detail_contract1`
    FOREIGN KEY (`contract_id`)
    REFERENCES `eventhos`.`contract` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `eventhos`.`contract_exc_try`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventhos`.`contract_exc_try` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_contract_exc_try_contract_exc_detail1`
    ...
    REFERENCES `eventhos`.`contract_exc_detail` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
